...
class ConstructeurVanneCirculaire:
    ...
    def _determiner_h_png_direct(
        ...
        alpha_1 = (
            ...
            - i1
            + b_s * (H_etoile * self.aG - self.aG**2 / 2.0)
        )
        alpha_0 = (
            ...
            + i2
            + b_s * (self.aG**3 / 3.0 - H_etoile * self.aG**2 / 2.0)
        )
...
def nom_base_sortie(parametres: ParametresVanne) -> str:
    ...
    nom = (
        ...
        f"aG{_format_nombre(parametres.aG)}_bG{bG}"
    )
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Construit une VSR a partir d'un fichier Excel de parametres."
    )
